...
//     return gameState;
//   }
//   if (gameState.children.length === 1) {
//     return gameState.children[0];
//   }
...
//   const propagateValue: Value = nodeToExplore.lastValue;
//   while (tempNode != null) {
//     tempNode.visitCount++;
//     if (nodeToExplore.status === GameStatus.Won) {
//       tempNode.winScore += 1;
//     }
...
//     if (tempNode.status === GameStatus.Tie) {
...
//   gameState.visitCount = 2;
//   while (Date.now() - startTime < time) {
//     count++;

//     if (count === 10) {
//       console.log({ parentVisit: gameState.visitCount });
//       console.log(
//         gameState.children.map((c) => {
//           return {
//             m: JSON.stringify(c.lastPlay),
//             v: c.visitCount,
//             ucb: ucbValue(gameState.visitCount, c.winScore, c.visitCount),
//             win: c.winScore,
//           };
//         })
//       );
...
//     debugMessage(gameState.children.length);
//     debugMessage(promissingNode.id);
//     const moveId = JSON.stringify(promissingNode.lastPlay);
//     if (nodes[moveId] === undefined) {
//       nodes[moveId] = 0;
//     } else {
//       nodes[moveId] += 1;
//     }
...
//     if (!promissingNode) {
//       console.error(gameState.children.length);
//       console.error(gameState);
//     }
...
//     {
//       board: [
//         [Value.X, Value.E, Value.O],
//         [Value.E, Value.X, Value.E],
...
//   tiedBoards: [],
//   status: -1,
//   lastPlay: { row: 5, col: 8 },
//   lastValue: Value.O,
//   moveHistory: [
//     { row: 0, col: 0, value: Value.X },
//     { row: 0, col: 2, value: Value.O },
//     { row: 1, col: 6, value: Value.X },
//     { row: 3, col: 1, value: Value.O },
//     { row: 1, col: 4, value: Value.X },
//     { row: 4, col: 4, value: Value.O },
//     { row: 3, col: 3, value: Value.X },
//     { row: 2, col: 0, value: Value.O },
//     { row: 8, col: 0, value: Value.X },
//     { row: 7, col: 1, value: Value.O },
//     { row: 5, col: 5, value: Value.X },
//     { row: 6, col: 7, value: Value.O },
//     { row: 0, col: 4, value: Value.X },
//     { row: 2, col: 4, value: Value.O },
//     { row: 7, col: 4, value: Value.X },
//     { row: 3, col: 4, value: Value.O },
//     { row: 2, col: 3, value: Value.X },
//     { row: 6, col: 0, value: Value.O },
//     { row: 1, col: 1, value: Value.X },
//     { row: 5, col: 4, value: Value.O },
//     { row: 8, col: 3, value: Value.X },
//     { row: 8, col: 2, value: Value.O },
//     { row: 7, col: 7, value: Value.X },
//     { row: 2, col: 5, value: Value.O },
//     { row: 7, col: 8, value: Value.X },
//     { row: 5, col: 7, value: Value.O },
//     { row: 7, col: 5, value: Value.X },
//     { row: 5, col: 8, value: Value.O },
//   ],
//   visitCount: 2,
//   winScore: 0,
//   loseScore: 0,
//   tieScore: 0,
//   totalMoves: 1,
//   id: "X-O-X-O---X--X-XOO---X------O-------XO--O--OX-------OOO---O-X-O----XXX---O--XX---",
//   parentNodeId: null,
//   wonChildren: [],
//   tiedChildren: [],
//   lostChildren: [],
...
// console.log("ucb", ucbValue(2, 0, 2));

// gameState_expand(initial_state);
// console.log(initial_state.children.map((c) => c.lastPlay));
// console.log("initial_state", initial_state.children.length);
// const move = monteCarloFindBestMove(initial_state, 500);
// console.log(move);
// const result = simulateRandomPlayout(initial_state);

// console.log("getBoardFromPlay", getNextBoardFromPlay(5, 8));
